        ...
        if (settings.newData) {
            ...
            if (settings.dataId) {
                ...
                if ($row.length) {
                    ...
                    var $row = $(this).find("[data-index-id='" + settings.dataId + "']");
                    if ($row.length) {
                        //table.fnDeleteRow($row.closest('tr'));
                    }
                }
            ...
            if ($row.length) {
                ...
                table.fnUpdateRow(null, table.api().page(), true); //update existing row
            } else {
...
(function($) {
    $.fn.appModifier = function(options) {
        ...
        if (settings.actionType === "select2") {
            containerDom = "<input id='" + tempId + "' value='" + settings.value + "' type='text' class='form-control' /> " + "<div class='custom-dom'>" + settings.customDom + "</div>" + buttonDom;
        ...
        function initAjaxAction($instance, value, settings, changedText) {
            ...
            $inputField.siblings(".custom-dom").addClass("hide");
            var data = { value: value };
            $inputField.siblings(".custom-dom").find("[name]").each(function(index, element) {
