...
class Compromises_reportables_rel_fields_model extends Crud_model {

    private $table = null;

    function __construct() {
        $this->table = 'compromisos_reportables_rel_campos';
	...
	function get_compromise_fields($id_compromiso){
		...
		$compromises_rel_fields_table = $this->db->dbprefix('compromisos_reportables_rel_campos');
	...
	function delete_compromises_rel_fields($id){
		...
		$compromisos_rel_campos = $this->db->dbprefix('compromisos_reportables_rel_campos');
