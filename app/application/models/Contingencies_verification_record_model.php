...
class Contingencies_verification_record_model extends Crud_model {

    private $table = null;

    function __construct() {
        $this->table = 'contingencias_verificacion';
        parent::__construct($this->table);
    }

    
    function get_details($options = array()){
        $contingencies_table = $this->db->dbprefix('contingencias_verificacion');
