...
<nav class="breadcrumb">
  ...
  <a class="breadcrumb-item" href="<?php echo get_uri(); ?>"><?php echo lang("profiles"); ?></a> 
</nav>

    <div class="panel panel-default">
        <div class="page-title clearfix">
            <h1><?php echo lang('profiles'); ?></h1>
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("profiles/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_profile'), array("class" => "btn btn-default", "title" => lang('add_profile'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#profiles-table").appTable({
            source: '<?php echo_uri("profiles/list_data"); ?>',
            columns: [
