...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        // Si el valor guardado en la configuración de separador de miles es punto se bloquea en el separador de decimales la opción punto, si el valor guardado es coma se bloquea la coma.
        var thousands_sep = $('#thousands_separator option:selected').val();
        if(thousands_sep == 1){
            $('#decimals_separator option[value="1"]').prop('disabled', true);
            $('#decimals_separator option[value="2"]').prop('disabled', false);
            $('#decimals_separator').select2('val', 2);

        }else if(thousands_sep == 2){    
