...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$("#individual_upload-table").appTable({
			...
			source: '<?php echo_uri("agreements_matrix_config/list_data_view_matrix/". $id_agreement_matrix_config) ?>',
			//order: [[1, "asc"]],
			columns: [
				{title: "ID", "class": "text-center w10"},
				{title: "<?php echo lang("code") ?>", "class": ""},
				{title: "<?php echo lang("name") ?>", "class": ""},
				{title: "<?php echo lang("description") ?>", "class": "text-center"},
				{title: "<?php echo lang("period") ?>", "class": "no_breakline"},
				{title: "<?php echo lang("managing") ?>", "class": ""}
				//{title: "<?php echo lang("observations") ?>", "class": ""},
				//{title: "<?php echo lang("evidences") ?>", "class": ""}
				<?php echo $columnas_campos ?>,
				{title: "<?php echo lang("stakeholders") ?>", "class": "no_breakline"}
