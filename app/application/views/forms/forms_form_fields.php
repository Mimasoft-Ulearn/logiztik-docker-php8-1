...
<div class="form-group">
	<label for="nombre" class="<?php echo $label_column; ?>">
...
<div class="form-group">
	<label for="descripcion" class="<?php echo $label_column; ?>">
...
if ($model_info->fijo) {
	...
	$info = '<span class="help" data-container="body" data-toggle="tooltip" title="' . lang('fixed_form_disabled_client_info') . '"><i class="fa fa-question-circle"></i></span>';
}
if ($campos_disabled) {
	$disabled = 'disabled="disabled"';
...
?>
<div class="form-group">
	<label for="client" class="<?php echo $label_column; ?>">
		<?php echo lang('client') . ' ' . $info; ?>
	</label>
	<div class="<?php echo $field_column; ?>">
		<?php
	...
	<?php if ($model_info->fijo || $campos_disabled) { ?>
...
if ($model_info->fijo) {
	$disabled = 'disabled="disabled"';
	$info = '<span class="help" data-container="body" data-toggle="tooltip" title="' . lang('fixed_form_disabled_project_info') . '"><i class="fa fa-question-circle"></i></span>';
}
if ($campos_disabled) {
	$disabled = 'disabled="disabled"';
	$info = '<span class="help" data-container="body" data-toggle="tooltip" title="' . lang('disabled_field_form_values_msj') . '"><i class="fa fa-question-circle"></i></span>';
...
<div id="proyectos_group">
	<div class="form-group">
		<label for="project" class="<?php echo $label_column; ?>">
			<?php echo lang('project') . ' ' . $info; ?>
		</label>
		<div class="<?php echo $field_column; ?>">
			<?php
...
?>
<div class="form-group">
	<label for="sge" class="<?php echo $label_column; ?>">
		<?php echo lang('form_number') . ' ' . $info; ?>
	</label>
	<div class="<?php echo $field_column; ?>">
		<?php
...
<div class="form-group">
	<label for="codigo" class="<?php echo $label_column; ?>">
		<?php echo lang("code"); ?>
	</label>
	<div class="<?php echo $field_column; ?>">
		<?php
...
<div class="form-group">
	<label for="icono" class="<?php echo $label_column; ?>">
		<?php echo lang("icon"); ?>
	</label>
	<div class="<?php echo $field_column; ?>">
		<select name="icono" id="icono" class="select2 validate-hidden" data-rule-required="true"
			data-msg-required="Este campo es requerido." tabindex="-1" title="iconos" aria-required="true">
			<option value="">-</option>
			<?php foreach ($iconos as $icono) { ?>
				<?php if ($icono == 'empty.png') {
					continue;
				} ?>
				<option value="<?php echo $icono ?>">
					<?php echo $icono ?>
				</option>
			<?php } ?>
		</select>
...
if ($model_info->fijo) {
	$disabled = 'disabled="disabled"';
	$info = '<span class="help" data-container="body" data-toggle="tooltip" title="' . lang('fixed_form_disabled_category_info') . '"><i class="fa fa-question-circle"></i></span>';
}
if ($campos_disabled) {
	$disabled = 'disabled="disabled"';
	$info = '<span class="help" data-container="body" data-toggle="tooltip" title="' . lang('disabled_field_form_values_msj') . '"><i class="fa fa-question-circle"></i></span>';
...
?>
<div class="form-group">
	<label for="tipo_formulario" class="<?php echo $label_column; ?>">
		<?php echo lang('category') . ' ' . $info; ?>
	</label>
	<div class="<?php echo $field_column; ?>">
		<?php
...
<div id="flow_group">
	...
	<?php if ($model_info->flujo) { ?>
		...
		<div class="form-group">
			<label for="flow" class="<?php echo $label_column; ?>">
				<?php echo lang('flow') . ' ' . $info; ?>
			</label>
			<div class="<?php echo $field_column; ?>">
...
<div id="unidad_residuos_group">
	...
	<?php if (($model_info->flujo == "Residuo") || ($model_info->flujo == "Consumo") || ($model_info->flujo == "No Aplica")) { ?>
		...
		<?php if ($model_info->unidad) { ?>
			...
			$info = '';
			if ($unidad_disabled_by_calculation) {
				$array_input_unit_field_name["disabled"] = "disabled";
				$info = '<span class="help" data-container="body" data-toggle="tooltip" title="' . lang('disabled_unit_by_calculation') . '"><i class="fa fa-question-circle"></i></span>';
			}
			...
			<div class="form-group">
				<label for="waste_unit" class="<?php echo $label_column; ?>">
					<?php echo lang('unit_field_name') . ' ' . $info; ?>
				</label>
				<div class="<?php echo $field_column; ?>">
					<?php
			...
			<div class="form-group multi-column">
				<label for="unit_field" class="<?php echo $label_column; ?>">
					<?php echo lang('unit_type') . ' ' . $info; ?>
				</label>
				<div class="col-md-4">
...
<div id="tipo_tratamiento_group">
	...
	<?php if ($model_info->flujo == "Residuo") { ?>
		...
		<div class="form-group">
			<label for="type_of_treatment" class="col-md-3">
				<?php echo lang('default_type_of_treatment') . ' ' . $info; ?>
			</label>
			<div class="col-md-4">
				<?php
			...
			<label for="disabled_field" class="col-md-3">
				<?php echo lang('disabled_field'); ?>
				<span class="help" data-container="body" data-toggle="tooltip"
					title="<?php echo lang('disabled_field_description') ?>"><i class="fa fa-question-circle"></i></span>
			</label>
			<div class="col-md-2">
				<?php
...
<div id="consumo_group">
	...
	<?php if ($model_info->flujo == "Consumo") { ?>
		...
		<div class="form-group">
			<label for="type_of_origin" class="col-md-3">
				<?php echo lang('type_of_origin') . ' ' . $info; ?>
			</label>
			<div class="col-md-4">
				<?php
			...
			<div class="col-md-2">
				...
				?>
				<?php if ($type_of_origin_disabled || $campos_disabled) { ?>
					<input type="hidden" name="disabled_field"
						value="<?php echo ($disabled_type_of_origin || $campos_disabled) ? true : false; ?>" />
				<?php } ?>
			</div>
		</div>
...
<div id="consumo_default_matter_group">
	...
	<?php if ($model_info->flujo == "Consumo" && $type_of_origin_name == "matter") { ?>
		...
		<div class="form-group">
			<label for="type_of_origin" class="col-md-3">
				<?php echo lang('default_matter') . ' ' . $info; ?>
			</label>
			<div class="col-md-4">
...
<div id="no_aplica_group">
	<?php if ($model_info->flujo == "No Aplica") { ?>
		...
		<div class="form-group">
			<label for="default_type" class="col-md-3">
				<?php echo lang('default_type') ?>
			</label>
			<div class="col-md-4">
				<?php
			...
			if (id_project) {
				...
				$.ajax({
					...
					success: function (respuesta) {
						...
						var codigo = sigla_proyecto + numero_formulario + nombre_registro.substring(0, 25);
						$('#codigo').val(codigo);
						appLoader.hide();
					}
				});
