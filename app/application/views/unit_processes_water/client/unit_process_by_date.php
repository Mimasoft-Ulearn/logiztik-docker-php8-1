		...
		<div class="tab-content">
			...
			<?php
				...
				foreach ($procesos_unitarios as $pu) {
					...
					foreach($huellas as $huella){
						...
						foreach($array_pu_categorias[$pu['id']] as $id_categoria => $nombre_categoria){
							...
							if(isset($uf_huella_pu[$unidad_funcional->id][$huella->id][$pu['id']][$id_categoria])){
								$valor = array_sum($uf_huella_pu[$unidad_funcional->id][$huella->id][$pu['id']][$id_categoria])/$valor_uf;
						...
						$total_pu_final = to_number_project_format(($uf_huella_pu[$unidad_funcional->id][$huella->id][$pu['id']]['total_pu']/$valor_uf), $project_info->id);
					...
					if(isset($array_pu_categorias[$pu['id']])){
						foreach($array_pu_categorias[$pu['id']] as $id_categoria => $nombre_categoria){
							$valor_ud = 0;
							$valor_ui = 0;
							$valor_sl = 0;
							...
							if(isset($uf_huella_pu[$unidad_funcional->id][30][$pu['id']][$id_categoria])){
								$valor_ud = array_sum($uf_huella_pu[$unidad_funcional->id][30][$pu['id']][$id_categoria])/$valor_uf;
							}
							if(isset($uf_huella_pu[$unidad_funcional->id][31][$pu['id']][$id_categoria])){
								$valor_ui = array_sum($uf_huella_pu[$unidad_funcional->id][31][$pu['id']][$id_categoria])/$valor_uf;
							}
							if(isset($uf_huella_pu[$unidad_funcional->id][32][$pu['id']][$id_categoria])){
								$valor_sl = array_sum($uf_huella_pu[$unidad_funcional->id][32][$pu['id']][$id_categoria])/$valor_uf;
							}
							if(isset($uf_huella_pu[$unidad_funcional->id][33][$pu['id']][$id_categoria])){
								$valor_se = array_sum($uf_huella_pu[$unidad_funcional->id][33][$pu['id']][$id_categoria])/$valor_uf;
							}

							$valor_ap = ($valor_ud + $valor_ui) - ($valor_sl + $valor_se);
							$valor_ac = ($valor_ap + $valor_se);

							$array_mayores_ap[$unidad_funcional->id]["ap"][$pu['id']][$id_categoria] = $valor_ap;
							$array_mayores_ac[$unidad_funcional->id]["ac"][$pu['id']][$id_categoria] = $valor_ac;
						...
						$valor_ud = $uf_huella_pu[$unidad_funcional->id][30][$pu['id']]['total_pu']/$valor_uf;
						$valor_ui = $uf_huella_pu[$unidad_funcional->id][31][$pu['id']]['total_pu']/$valor_uf;
						$valor_sl = $uf_huella_pu[$unidad_funcional->id][32][$pu['id']]['total_pu']/$valor_uf;
						$valor_se = $uf_huella_pu[$unidad_funcional->id][33][$pu['id']]['total_pu']/$valor_uf;
					...
					// PARA CALCULO DE HUELLAS FIJAS
					if(isset($array_pu_categorias[$pu['id']])){
						$max_categoria_ap = array_keys($array_mayores_ap[$unidad_funcional->id]["ap"][$pu['id']], max($array_mayores_ap[$unidad_funcional->id]["ap"][$pu['id']]));
						if(count($max_categoria_ap) == 1){
							$array_categorias_mayores[lang("water_in_product")] = $categorias[$max_categoria_ap[0]];
						}
						$max_categoria_ac = array_keys($array_mayores_ac[$unidad_funcional->id]["ac"][$pu['id']], max($array_mayores_ac[$unidad_funcional->id]["ac"][$pu['id']]));
				...
				$final_uf_pdf[$unidad_funcional->id] = $result_pdf;
