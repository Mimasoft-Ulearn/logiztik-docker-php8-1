...
<h2 align="center" style="text-decoration: underline; font-family: Times New Roman, Times, serif;">
	<?php echo ucwords(lang("water_environmental_footprints"))." - ".lang("unit_processes"); ?>
</h2>
<div align="center">
...
<br>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            <td align="center">
            	<img src="<?php echo $imagenes_graficos[$unidad_funcional->id]["water_in_product"]; ?>" style="height: 200px; width: 300px;"/>
            </td>
            <td align="center">
            	<img src="<?php echo $imagenes_graficos[$unidad_funcional->id]["consumed_water"]; ?>" style="height: 200px; width: 300px;"/>
            </td>
        </tr>
    ...
    <table cellpadding="4" cellspacing="0" border="1">
        ...
        <tbody>
            <?php foreach($appTable_data as $index => $valores) { ?>
				...
				<?php if($index == $unidad_funcional->id) { ?>
                    ...
                    <?php foreach($valores as $valor) { ?>
                        ...
                        <?php if(!empty($valor["categorias"])) { ?>
                            ...
                            <tr>
                            	<td colspan="<?php echo count($columnas) + 1 + 2; ?>"><?php echo lang("categories"); ?></td>
                            </tr>
