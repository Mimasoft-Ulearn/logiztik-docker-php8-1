<?php 
echo form_open(get_uri("relationship/save_asignacion_edit"), array("id" => "asignacion-form-edit", "class" => "general-form", "role" => "form", "autocomplete" => "off")); ?>
<div class="modal-body clearfix">
    ...
    <div class="tab-content mt15">
        <div role="tabpanel" class="tab-pane active" id="general-info-tab">
           ...
           <?php $this->load->view("relationship/asignacion/asignacion_uno_fields_edit"); ?>
            
        </div>
        <div role="tabpanel" class="tab-pane" id="job-info-tab">
        
            <?php $this->load->view("relationship/asignacion/asignacion_dos_fields_edit"); ?>
            
        </div>
        <div role="tabpanel" class="tab-pane" id="account-info-tab">
        	
            <?php $this->load->view("relationship/asignacion/asignacion_tres_fields_edit"); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#asignacion-form-edit input").keydown(function(e) {
            if (e.keyCode === 13) {
                e.preventDefault();
                if ($('#form-submit').hasClass('hide')) {
                    $("#form-next").trigger('click');
                } else {
                    $("#asignacion-form-edit").trigger('submit');
                }
            }
        });
