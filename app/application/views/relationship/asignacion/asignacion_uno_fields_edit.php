...
<div class="form-group">
    ...
    <div class="<?php echo $field_column; ?>">
        <?php
		echo form_dropdown("client_id2", $clientes, $model_info->id_cliente, "id='client_id2' class='select2 validate-hidden' data-rule-required='true' data-msg-required='" . lang('field_required') . "'");
		?>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="<?php echo $field_column; ?>">
        <?php
        echo form_dropdown("project2", $proyectos, $model_info->id_proyecto, "id='project2' class='select2 validate-hidden' data-rule-required='true' data-msg-required='" . lang('field_required') . "'");
        ?>
    </div>
</div>
...
<div id="criterio_group" class="form-group">
    ...
    <div class="<?php echo $field_column; ?>">
        <?php
        echo form_dropdown("criterio2", $criterios, $model_info->id_criterio, "id='criterio2' class='select2 validate-hidden' data-rule-required='true' data-msg-required='" . lang('field_required') . "'");
        ?>
    </div>
</div>
