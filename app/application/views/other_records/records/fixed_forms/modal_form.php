<?php echo form_open(get_uri("other_records/save_element_fixed_form/".$id_other_record), array("id" => "other_records-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <?php $this->load->view("other_records/records/fixed_forms/other_records_form_fields"); ?>
</div>
