            ...
            <div class="panel panel-default">
                <div class="page-title clearfix panel-sky">
                    ...
                    <div class="title-button-group">
						...
						<?php 
						if ($record_info->fijo && $record_info->codigo_formulario_fijo != 'or_unidades_funcionales') {
							
							echo modal_anchor(get_uri("other_records/modal_charts/".$record_info->id), "<i class='fa fa-eye'></i> ".lang('view_charts'), array("id" => 'modal_charts', "class" => "btn btn-default", "title" => lang('graphs').' '.$record_info->nombre));
						}
						?>
				...
				$("#other_records-table").appTable({
					...
					columns: [
						...
						<?php } else { ?>
							...
							{title: "<?php echo lang("id"); ?>", "class": "text-center w50 hide"},
							{title: "<?php echo lang("created_by"); ?>", "class": "text-center w50 hide", visible: false},
							{title: "<?php echo lang("year_semester"); ?>", "class": "text-center w50 "},
