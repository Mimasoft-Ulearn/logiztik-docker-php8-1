            ...
            <div class="tab-title clearfix">
                ...
                <div class="title-button-group">
                    ...
                    <?php if($puede_agregar != 3){
                        echo modal_anchor(get_uri("contingencies_record/modal_form_verification"), "<i class='fa fa-plus-circle'></i> " . lang('add_verification'), array("id" => "agregar_info", "class" => "btn btn-default", "title" => lang('add_verification')));
                    } ?>
                </div>
            </div>
        
            <div class="table-responsive">
                <table id="verification-table" class="display" width="100%">            
                </table>
            </div>
        </div>
<?php } else { ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		$("#verification-table").appTable({
			source: '<?php echo_uri("contingencies_record/list_data_verification/"); ?>',
			//order: [[1, "asc"]],
			columns: [
