    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer clearfix">
				...
				<?php echo $info = '<span class="help pull-left pl15 pt5" data-container="body" data-toggle="tooltip" title="'.lang('upload_image_info').'"><i class="fa fa-question-circle"></i></span>'; ?>
                <button id="image-close-button" type="button" class="btn btn-default"> <i class="fa fa-times"></i> <?php echo lang("close"); ?></button>
                ...
                <button id="image-crop-button" type="button" class="btn btn-primary"> <i class="fa fa-check-circle"></i> <?php echo lang("crop"); ?></button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
        ...
        if (file) {
            ...
            if (typeof FileReader == 'function') {
                ...
                setTimeout(function() {
					...
					if($("#cropModal").hasClass('hide')){
						$("#cropModal").removeClass('hide');
					}else{
						$("#cropModal").modal('toggle');
					}
                    setTimeout(function() {
    ...
    $(document).ready(function() {
		...
		//$('#cropModal').on('click', '#image-close-button', function(e) { e.stopPropagation(); });
		$('#image-close-button').on('click', function() {
			$("#cropModal").addClass('hide');
			//$("#cropModal").modal('hide');
