<div class="form-group">
    <div class="col-sm-12 col-md-12 p0">
        <div id="file-upload-dropzone_reception" class="dropzone mb15">

        </div>
        <div id="file-upload-dropzone-scrollbar_reception">
            <div id="uploaded-file-previews_reception">
                <div id="file-upload-row_reception" class="box">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var previewNode = document.querySelector("#file-upload-row_reception");
        previewNode.id = "";
        var previewTemplate = previewNode.parentNode.innerHTML;
        previewNode.parentNode.removeChild(previewNode);

        var dropzoneId="#file-upload-dropzone_reception";

        var projectFilesDropzone = new Dropzone(dropzoneId, {
            url: "<?php echo $upload_url; ?>" + "/reception_file",
            thumbnailWidth: 80,
            thumbnailHeight: 80,
            parallelUploads: 20,
            //maxFilesize: 3000,
            ...
            autoQueue: true,
            previewsContainer: "#uploaded-file-previews_reception",
            clickable: true,
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            $(file.previewTemplate).append("<input type='hidden' name='file_name_reception' value='" + file.name + "' />\n\
            ...
            fallback: function () {
                ...
                $("#file-upload-dropzone_reception").hide();
                ...
                $(dropzoneId).closest('form').find(".modal-footer").on("click", "#add-more-file-button", function () {
                    var newFileRow = "<div class='file-row pb10 pt10 b-b mb10'>"
                            ...
                            + "</div>";
                    $("#uploaded-file-previews_reception").prepend(newFileRow);
                });
                $("#add-more-file-button").trigger("click");
                $("#uploaded-file-previews_reception").on("click", ".remove-file", function () {
