<div class="form-group">
    <div class="col-sm-12 col-md-12 p0">
        <div id="file-upload-dropzone_waste_manifest" class="dropzone mb15">

        </div>
        <div id="file-upload-dropzone-scrollbar_waste_manifest">
            <div id="uploaded-file-previews_waste_manifest">
                <div id="file-upload-row_waste_manifest" class="box">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var previewNode = document.querySelector("#file-upload-row_waste_manifest");
        previewNode.id = "";
        var previewTemplate = previewNode.parentNode.innerHTML;
        previewNode.parentNode.removeChild(previewNode);

        var dropzoneId="#file-upload-dropzone_waste_manifest";

        var projectFilesDropzone = new Dropzone(dropzoneId, {
            url: "<?php echo $upload_url; ?>" + "/waste_manifest_file",
            thumbnailWidth: 80,
            thumbnailHeight: 80,
            parallelUploads: 20,
            //maxFilesize: 3000,
            ...
            autoQueue: true,
            previewsContainer: "#uploaded-file-previews_waste_manifest",
            clickable: true,
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            $(file.previewTemplate).append("<input type='hidden' name='file_name_waste_manifest' value='" + file.name + "' />\n\
            ...
            fallback: function () {
                ...
                $("#file-upload-dropzone_waste_manifest").hide();
                ...
                $(dropzoneId).closest('form').find(".modal-footer").on("click", "#add-more-file-button", function () {
                    var newFileRow = "<div class='file-row pb10 pt10 b-b mb10'>"
                            ...
                            + "</div>";
                    $("#uploaded-file-previews_waste_manifest").prepend(newFileRow);
                });
                $("#add-more-file-button").trigger("click");
                $("#uploaded-file-previews_waste_manifest").on("click", ".remove-file", function () {
