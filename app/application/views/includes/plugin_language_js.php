<script type="text/javascript">
	...
	AppLanugage.resetZoom = "<?php echo lang('resetZoom'); ?>";
	AppLanugage.resetZoomTitle = "<?php echo lang('resetZoomTitle'); ?>";
	AppLanugage.contextButtonTitle = "<?php echo lang('contextButtonTitle'); ?>";
	
	AppLanugage.loading = "<?php echo lang('loading...'); ?>";
	AppLanugage.formatNoMatches = "<?php echo lang('no_matches_found'); ?>";
