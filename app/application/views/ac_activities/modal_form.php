<?php echo form_open(get_uri("AC_Activities/save"), array("id" => "activities-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <?php $this->load->view("ac_activities/activities_form_fields"); ?>
</div>
        ...
        $("#activities-form").appForm({
            onSuccess: function(result) {
                if (result.view === "details") {
                    ...
                    $("#activities-table").appTable({newData: result.data, dataId: result.id});
                }
            }
        });
		//$("#activities-form").validate().settings.ignore = "";
        //$("#company_name").focus();
			...
			$.ajax({
				...
				success: function (result) {
					if (result.success) {
						...
						$('#activities-form').append('<input type="hidden" name="id_campo_archivo_eliminar[]" value="' + result.id_campo + '" />');
