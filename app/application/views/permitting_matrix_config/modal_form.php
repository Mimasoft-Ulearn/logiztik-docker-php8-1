<?php echo form_open(get_uri("permitting_matrix_config/save"), array("id" => "matrix_config-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <?php $this->load->view("permitting_matrix_config/matrix_config_form_fields"); ?>
</div>
