...
<div class="form-group">
    ...
    <div class="<?php echo $field_column; ?>">
		...
		$categorias = array(
		 	"" => "-",
			"Tramitación" => lang("procedure"),
			"Cumplimiento de Actividades" => lang("activities_compliance"),
			"Cumplimiento Financiero" => lang("financial_compliance"),
		);
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#communities_evaluation_status-form .select2').select2();
