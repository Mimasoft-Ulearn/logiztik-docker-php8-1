...
<nav class="breadcrumb"> 
  ...
  <a class="breadcrumb-item" href="<?php echo get_uri(); ?>"><?php echo lang("stakeholders_matrix_config"); ?></a>
</nav>

    <div class="panel panel-default">
        <div class="page-title clearfix">
            <h1><?php echo lang('stakeholders_matrix_config'); ?></h1>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#matrix_config-table").appTable({
            source: '<?php echo_uri("stakeholders_matrix_config/list_data"); ?>',
			filterDropdown: [
