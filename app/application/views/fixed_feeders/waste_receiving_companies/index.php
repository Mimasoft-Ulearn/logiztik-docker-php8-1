<div id="page-content" class="p20 clearfix">
    ...
    <nav class="breadcrumb"> 
      ...
      <a class="breadcrumb-item" href=""><?php echo lang("waste_receiving_companies"); ?></a>
    </nav>
	...
	<div class="row">
    	<div class="col-md-12">
        	...
        	<div class="page-title clearfix">
            	<h1><i class="fa fa-table" title="Abierto"></i> <?php echo lang("waste_receiving_companies"); ?></h1>
            </div>
            ...
            <div class="panel panel-default">
                <div class="page-title clearfix panel-sky">
                    <h1><?php echo lang("waste_receiving_companies"); ?></h1>
                    <div class="title-button-group">
                        ...
                        <?php echo modal_anchor(get_uri("feeders/fixed_feeders_modal_form/waste_receiving_companies"), "<i class='fa fa-plus-circle'></i> " . lang('add') . ' ' . lang("waste_receiving_companies"), array("id" => "agregar_elemento", "class" => "btn btn-default", "title" => lang('add') . ' ' . lang("waste_receiving_companies"))); ?>
                    </div>
	...
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#feeders-table").appTable({	
                source: '<?php echo_uri("feeders/fixed_feeders_list_data/waste_receiving_companies") ?>',
                columns: [
					...
					{title: "<?php echo lang("company_code"); ?>", "class": "text-left dt-head-center"},
					{title: "<?php echo lang("receiving_establishment_treatment"); ?>", "class": "text-left dt-head-center"},
					{title: "<?php echo lang("address"); ?>", "class": "text-left dt-head-center"},
					{title: "<?php echo lang("region"); ?>", "class": "text-left dt-head-center"},
					...
					{title: "<?php echo lang("modified_date"); ?>", "class": "text-left dt-head-center"},
			...
			$('#excel').click(function(){					
				var $form = $('<form id="gg"></form>').attr('action','<?php echo_uri("Feeders/fixed_feeders_get_excel/waste_receiving_companies"); ?>').attr('method','POST').attr('target', '_self').appendTo('body');
				$form.submit();
			});
		...
		<?php } ?>
			...
			$(document).on('click', '#delete_selected_rows', function() {
				...
				$("#confirmMultipleDeleteButton").attr("data-action-url", "<?php echo get_uri("feeders/fixed_feeders_delete_multiple/waste_receiving_companies"); ?>");
