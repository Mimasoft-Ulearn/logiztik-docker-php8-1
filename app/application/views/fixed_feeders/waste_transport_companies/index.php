<div id="page-content" class="p20 clearfix">
    ...
    <nav class="breadcrumb"> 
      ...
      <a class="breadcrumb-item" href=""><?php echo lang("waste_transport_companies"); ?></a>
    </nav>
	...
	<div class="row">
    	<div class="col-md-12">
        	...
        	<div class="page-title clearfix">
            	<h1><i class="fa fa-table" title="Abierto"></i> <?php echo lang("waste_transport_companies"); ?></h1>
            </div>
            ...
            <div class="row" style="background-color:#E5E9EC;">
                <div class="col-md-4">
                	<div class="row">
                        ...
                        <img src="<?php echo get_file_uri("assets/images/icons/empty.png"); ?>" alt="..." style="background-color:#FFF;" class="mCS_img_loaded">
                        </span>
                        </div>
            ...
            <div class="panel panel-default">
                <div class="page-title clearfix panel-sky">
                    <h1><?php echo lang("waste_transport_companies"); ?></h1>
                    <div class="title-button-group">
                        ...
                        <?php echo modal_anchor(get_uri("feeders/fixed_feeders_modal_form/waste_transport_companies"), "<i class='fa fa-plus-circle'></i> " . lang('add') . ' ' . lang("waste_transport_companies"), array("id" => "agregar_elemento", "class" => "btn btn-default", "title" => lang('add') . ' ' . lang("waste_transport_companies"))); ?>
                    </div>
	...
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#feeders-table").appTable({	
                source: '<?php echo_uri("feeders/fixed_feeders_list_data/waste_transport_companies") ?>',
                columns: [
					...
					{title: "<?php echo lang("company_name_2"); ?>", "class": "text-left dt-head-center"},
					{title: "<?php echo lang("company_rut"); ?>", "class": "text-left dt-head-center"},
					{title: "<?php echo lang("company_registration_code"); ?>", "class": "text-left dt-head-center"},
					{title: "<?php echo lang("patent_plate"); ?>", "class": "text-left dt-head-center"},
					{title: "<?php echo lang("created_by"); ?>", "class": "text-center"},
					{title: "<?php echo lang("created_date"); ?>", "class": "text-left dt-head-center w100"},
					{title: "<?php echo lang("modified_date"); ?>", "class": "text-left dt-head-center w100"},
			...
			$('#excel').click(function(){					
				var $form = $('<form id="gg"></form>').attr('action','<?php echo_uri("Feeders/fixed_feeders_get_excel/waste_transport_companies"); ?>').attr('method','POST').attr('target', '_self').appendTo('body');
				$form.submit();
			});
		...
		<?php } ?>
			...
			$(document).on('click', '#delete_selected_rows', function() {
				...
				$("#confirmMultipleDeleteButton").attr("data-action-url", "<?php echo get_uri("feeders/fixed_feeders_delete_multiple/waste_transport_companies"); ?>");
