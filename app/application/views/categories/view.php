<?php echo form_open("", array("id" => "categories-form", "class" => "general-form", "role" => "form")); ?>
...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        <label for="categoria" class="col-md-3"><?php echo lang('subcategories'); ?></label>
        <div class="col-md-9">
        
            <?php 
                $array_nombres = array();
				foreach($subcategorias2 as $index => $cat){
