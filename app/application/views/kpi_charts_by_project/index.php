<div id="page-content" class="clearfix p20">
    ...
    <nav class="breadcrumb"> 
      ...
      <a class="breadcrumb-item" href=""><?php echo lang("charts_by_project"); ?></a>
    </nav>
    ...
    <?php if($puede_ver == 1) { ?>
		...
		<?php echo form_open(get_uri("KPI_Charts_by_project/save"), array("id" => "kpi_charts_by_project-form", "class" => "general-form", "role" => "form")); ?>

        <div class="panel-default">
        
            <div class="page-title clearfix">
                <h1><?php echo lang('charts_by_project'); ?></h1>
            </div>
            ...
            <div class="panel-footer clearfix">
            	<div class="pull-right">
                    <div class="btn-group" role="group">
                        <button id="generar_kpi_charts_by_project" type="submit" class="btn btn-primary"><span class="fa fa-check-circle"></span> <?php echo lang('generate_kpi_charts_by_project'); ?></button>
                    </div>
                    <div class="btn-group" role="group">
    ...
    <div class="panel">
    	<div class="panel-default">
			<div id="kpi_charts_by_project_group"></div>
        </div>
    </div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#kpi_charts_by_project-form .select2').select2();
		
		setDatePicker("#start_date");
		setDatePicker("#end_date");
		
		$("#kpi_charts_by_project-form").appForm({
            ajaxSubmit: false
        });
		...
		$('#pais').change(function(){	
			...
			$.ajax({
				url:  '<?php echo_uri("KPI_Charts_by_project/get_project_filter") ?>',
				type:  'post',
		...
		$("#kpi_charts_by_project-form").submit(function(e){
			e.preventDefault();
			return false;
		});
		
		$('#generar_kpi_charts_by_project').click(function(e){
			
			$("#export_pdf").off('click');
			$('#export_pdf').attr('disabled', true);
			$("#kpi_charts_by_project-form").valid();
			...
			if(id_proyecto && start_date && end_date){
				if((start_date < end_date) || (start_date == end_date)){
					...
					$.ajax({
						url:  '<?php echo_uri("KPI_Charts_by_project/get_kpi_report") ?>',
						type:  'post',
						data: {
							...
							end_date: end_date
					   		...
					   		$('#kpi_charts_by_project_group').html('<div style="padding:20px;"><div class="circle-loader"></div><div>');
						},
						
						//dataType:'json',
						success: function(respuesta){;
							$('#kpi_charts_by_project_group').html(respuesta);
