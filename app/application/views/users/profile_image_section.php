<div class="box">
    <div class="box-content w200 text-center profile-image">
        ...
        <?php //echo $info = '<span class="help" data-container="body" data-toggle="tooltip" title="'.lang('user_logo_info').'"><i class="fa fa-question-circle"></i></span>'; ?>
        <?php echo form_close(); ?>
    </div> 


    <div class="box-content pl15">
    	<?php if($user_info->cargo){ ?>
        <p class="p10 m0"><label class="label label-info large"><strong> <?php echo $user_info->cargo; ?> </strong></label></p> 
		<?php } ?>
