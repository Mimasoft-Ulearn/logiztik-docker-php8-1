    <div class="panel">
            <?php echo form_open(get_uri("upload_permittings/save_carga_masiva"), array("id" => "bulk_load-form", "class" => "general-form", "role" => "form")); ?>
                ...
                <div class="panel-body">
                    ...
                    <div id="dropzone_bulk" class="col-md-12">
                        ...
                        echo $this->load->view("includes/bulk_file_uploader", array(
                            "upload_url" => get_uri("upload_permittings/upload_file"),
                            "validation_url" =>get_uri("upload_permittings/validate_file"),
                            //"html_name" => 'test',
