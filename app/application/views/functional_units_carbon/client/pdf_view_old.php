...
<div align="center">
  ...
  <?php if($puede_ver == 1) { ?>
		...
		if($start_date && $end_date){
			...
			$fecha_inicio_mes = $array_periodos[$array_categorias_fechas[0]]['start_date'];
			$fecha_termino_mes = $array_periodos[$array_categorias_fechas[11]]['end_date'];
			$valor_uf = get_functional_unit_value($client_info->id, $proyecto->id, $unidad_funcional->id, $fecha_inicio_mes, $fecha_termino_mes);
		}
