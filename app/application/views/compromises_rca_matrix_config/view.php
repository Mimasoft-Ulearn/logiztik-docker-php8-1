...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$("#individual_upload-table").appTable({
			...
			source: '<?php echo_uri("compromises_rca_matrix_config/list_data_view_matrix/". $id_compromiso_proyecto) ?>',
			//order: [[1, "asc"]],
			columns: [
				{title: "<?php echo lang("n_compromise") ?>", "class": "text-center dt-head-center w10"},
				{title: "<?php echo lang("name") ?>", "class": "text-left dt-head-center w10"},
