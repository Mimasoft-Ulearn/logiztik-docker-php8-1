		...
		foreach($array_id_categorias_valores_volumen as $id_categoria => $arreglo_valores){
			...
			foreach($years as $year){
				...
				foreach($arreglo_valores[$year] as $id_sucursal => $valor_sucursal){
					$array_material_subprojects_values_year_volumen_consumo[$nombre_material][$array_subprojects[$id_sucursal]][$year] += $valor_sucursal;
				}
	...
	foreach($array_id_materiales_valores_masa as $id_material => $array_id_categorias_valores_masa){
		...
		foreach ($array_id_categorias_valores_masa as $id_categoria => $arreglo_valores){
			...
			foreach($years as $year){
				...
				foreach($arreglo_valores[$year] as $id_sucursal => $valor_sucursal){
					$array_material_subprojects_values_year_masa_consumo[$nombre_material][$array_subprojects[$id_sucursal]][$year] += $valor_sucursal;
				}
	...
	foreach ($array_id_materiales_valores_energia as $id_material => $array_id_categorias_valores_energia){
		...
		foreach ($array_id_categorias_valores_energia as $id_categoria => $arreglo_valores){
			...
			foreach($years as $year){
				...
				foreach($arreglo_valores[$year] as $id_sucursal => $valor_sucursal){
					$array_material_subprojects_values_year_energia_consumo[$nombre_material][$array_subprojects[$id_sucursal]][$year] += $valor_sucursal;
				}
							...
							<div id="tabla_consumo_volumen_subprojects" class="col-md-12 p0">
								<div class="page-title p10" style="border-bottom: none !important;">
									...
									<table id="table-consumo_volumen_subproject" class="table table-responsive table-striped">
										...
										<tbody>
											<?php foreach($array_material_subprojects_values_year_volumen_consumo as $nombre_material => $array_data_subprojects) { ?>
							...
							<div id="tabla_consumo_masa_subprojects" class="col-md-12 p0">
								<div class="page-title p10" style="border-bottom: none !important;">
									...
									<table id="table-consumo_masa_subproject" class="table table-responsive table-striped">
										...
										<tbody>
											<?php foreach($array_material_subprojects_values_year_masa_consumo as $nombre_material => $array_data_subprojects) { ?>
												<?php foreach($array_data_subprojects as $name_subproject => $array_data) { ?>
													<tr>
														<td class="text-left"><?php echo $nombre_material; ?></td>
														<td class="text-left"><?php echo $name_subproject; ?></td>
							...
							<div id="tabla_consumo_energia_subprojects" class="col-md-12 p0">
								<div class="page-title p10" style="border-bottom: none !important;">
									...
									<table id="table-consumo_energia_subproject" class="table table-responsive table-striped">
										...
										<tbody>
											<?php foreach($array_material_subprojects_values_year_energia_consumo as $nombre_material => $array_data_subprojects) { ?>
												<?php foreach($array_data_subprojects as $name_subproject => $array_data) { ?>
													<tr>
														<td class="text-left"><?php echo $nombre_material; ?></td>
														<td class="text-left"><?php echo $name_subproject; ?></td>
