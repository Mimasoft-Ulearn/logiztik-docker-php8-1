<div id="page-content" class="clearfix p20">
    ...
    <nav class="breadcrumb"> 
      ...
      <a class="breadcrumb-item" href=""><?php echo lang("charts_between_projects"); ?></a>
    </nav>
    ...
    <?php if($puede_ver == 1) { ?>
		...
		<?php echo form_open(get_uri("KPI_Charts_between_projects/save"), array("id" => "kpi_charts_between_projects-form", "class" => "general-form", "role" => "form")); ?>
            ...
            <div class="panel-body">
            	...
            	<div class="col-md-12">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="<?php echo $field_column ?>">
                            <?php
                            echo form_dropdown("tecnologia", $tecnologias, "", "id='tecnologia' class='select2'");
                            ?>
                        </div>
                    </div>
            ...
            <div class="panel-footer clearfix">
            	<div class="pull-right">
                    <div class="btn-group" role="group">
               			<button id="generar_kpi_charts_between_projects" type="submit" class="btn btn-primary pull-right"><span class="fa fa-check-circle"></span> <?php echo lang('generate_kpi_charts_between_project'); ?></button>
                    </div>
                    <div class="btn-group" role="group">
    ...
    <div class="panel">
    	<div class="panel-default">
			<div id="kpi_charts_between_projects_group"></div>
        </div>
    </div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#kpi_charts_between_projects-form .select2').select2();
		
		setDatePicker("#start_date");
		setDatePicker("#end_date");
		
		$("#kpi_charts_between_projects-form").appForm({
            ajaxSubmit: false
        });
		
		$('#generar_kpi_charts_between_projects').click(function(e){
			
			$("#export_pdf").off('click');
			
			$('#export_pdf').attr('disabled', true);
			
			$("#kpi_charts_between_projects-form").valid();
			...
			if(start_date && end_date){
				if((start_date < end_date) || (start_date == end_date)){
					...
					$.ajax({
						url:  '<?php echo_uri("KPI_Charts_between_projects/get_kpi_report") ?>',
						type:  'post',
						data: {
							id_pais: id_pais,
							id_fase: id_fase,
							...
							end_date: end_date
					   		...
					   		$('#kpi_charts_between_projects_group').html('<div style="padding:20px;"><div class="circle-loader"></div><div>');
						},
						
						//dataType:'json',
						success: function(respuesta){;
							$('#kpi_charts_between_projects_group').html(respuesta);
		...
		$("#kpi_charts_between_projects-form").submit(function(e){
			e.preventDefault();
			return false;
		});
