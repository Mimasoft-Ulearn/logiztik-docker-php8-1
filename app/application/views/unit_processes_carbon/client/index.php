<div id="page-content" class="p20 clearfix">
	...
	<nav class="breadcrumb">
		...
		<a class="breadcrumb-item" href="<?php echo get_uri("unit_processes_carbon"); ?>"><?php echo lang("unit_processes"); ?></a>
	</nav>
	...
	$('#btn_generar').click(function(){
		...
		if(start_date && end_date){
			if((start_date < end_date) || (start_date == end_date)){
				...
				$.ajax({
					url:'<?php echo_uri("unit_processes_carbon/get_unit_processes"); ?>',
					type:'post',
					data:{
