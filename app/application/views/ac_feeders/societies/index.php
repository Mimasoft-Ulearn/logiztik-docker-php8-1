<div id="page-content" class="p20 clearfix">
    ...
    <nav class="breadcrumb"> 
      ...
      <a class="breadcrumb-item" href="<?php echo get_uri("AC_Feeders/societies"); ?>"><?php echo lang("societies"); ?></a>
    </nav>
	...
	<div class="row">
    	<div class="col-md-12">
        	...
        	<div class="page-title clearfix">
            	<h1><i class="fa fa-table" title="Abierto"></i> <?php echo lang("societies"); ?></h1>
            </div>
                ...
                <div class="page-title clearfix panel-sky">
                    ...
                    <div class="title-button-group">
						...
						<div class="btn-group" role="group">
							...
							<?php echo modal_anchor(get_uri("AC_Feeders/modal_form_societies/"), "<i class='fa fa-plus-circle'></i> " . lang('add_society'), array("id" => "agregar_elemento", "class" => "btn btn-default", "title" => lang('add_society'))); ?>
                    </div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#feeders-table").appTable({	
			source: '<?php echo_uri("AC_Feeders/list_data_societies") ?>',
			columns: [
				...
				{title: "<?php echo lang("society_name"); ?>", "class": "text-left dt-head-center"},
		...
		$('#excel').click(function(){
			var $form = $('<form id="gg"></form>').attr('action','<?php echo_uri("AC_Feeders/get_excel/societies")?>').attr('method','POST').attr('target', '_self').appendTo('body');
			$form.submit();
		});
		...
		$(document).on('click', '#delete_selected_rows', function() {
			...
			$("#confirmMultipleDeleteButton").attr("data-action-url", "<?php echo get_uri("AC_Feeders/delete_societies_multiple/"); ?>");
