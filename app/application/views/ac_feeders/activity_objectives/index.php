<div id="page-content" class="p20 clearfix">
    ...
    <nav class="breadcrumb"> 
      ...
      <a class="breadcrumb-item" href="<?php echo get_uri("AC_Feeders/activity_objectives"); ?>"><?php echo lang("ac_activity_objectives"); ?></a>
    </nav>
	...
	<div class="row">
    	<div class="col-md-12">
        	...
        	<div class="page-title clearfix">
            	<h1><i class="fa fa-table" title="Abierto"></i> <?php echo lang("ac_activity_objectives"); ?></h1>
            </div>
            
            <?php $icono = get_file_uri("assets/images/icons/earth-day.png"); ?>
                ...
                <div class="col-md-8">
                	<div class="row">
                        ...
                        <div class="p15" align="justify">
                        	<?php echo lang('desc_activity_objectives'); ?>
                        </div>
                        </div>
                        </div>
                    </div>
                ...
                <div class="page-title clearfix panel-sky">
                    ...
                    <div class="title-button-group">
						...
						<div class="btn-group" role="group">
							...
							<?php echo modal_anchor(get_uri("AC_Feeders/modal_form_activity_objectives/"), "<i class='fa fa-plus-circle'></i> " . lang('add_objectives'), array("id" => "agregar_elemento", "class" => "btn btn-default", "title" => lang('add_objectives'))); ?>
                    </div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#feeders-table").appTable({	
			source: '<?php echo_uri("AC_Feeders/list_data_activity_objectives") ?>',
			columns: [
				...
				{title: "<?php echo lang("activity_type"); ?>", "class": "text-left dt-head-center"},
		...
		$('#excel').click(function(){
			var $form = $('<form id="gg"></form>').attr('action','<?php echo_uri("AC_Feeders/get_excel/ac_activity_objectives")?>').attr('method','POST').attr('target', '_self').appendTo('body');
			$form.submit();
		});
		...
		$(document).on('click', '#delete_selected_rows', function() {
			...
			$("#confirmMultipleDeleteButton").attr("data-action-url", "<?php echo get_uri("AC_Feeders/delete_activity_objectives_multiple/"); ?>");
