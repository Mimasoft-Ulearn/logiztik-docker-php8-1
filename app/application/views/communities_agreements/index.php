		...
		<?php if($id_agreements_matrix_config){ ?>
			...
			$("#communities_agreements-table").appTable({
				...
				columns: [
					...
					{title: "<?php echo lang("execution_date_period"); ?>", "class": "text-left dt-head-center no_breakline"},
					{title: "<?php echo lang("managing"); ?>", "class": "text-left dt-head-center"}			
					<?php echo $columnas_campos; ?>,		
					{title: "<?php echo lang("interest_groups"); ?>", "class": "text-left dt-head-center no_breakline"},
