...
<nav class="breadcrumb"> 
  ...
  <a class="breadcrumb-item" href="<?php echo get_uri("KPI_Report"); ?>"><?php echo lang("kpi_report") ?></a>
</nav>
    ...
    <div class="panel panel-default">
        ...
        <div class="table-responsive">
            <table id="kpi_report-table" class="display" cellspacing="0" width="100%">            
            </table>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#kpi_report-table").appTable({
            source: '<?php echo_uri("KPI_Report/list_data") ?>',
			filterDropdown: [
