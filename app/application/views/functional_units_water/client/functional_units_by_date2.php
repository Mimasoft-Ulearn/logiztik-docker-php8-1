...
<ul id="ul_menu_unidades_funcionales" class="nav nav-tabs vertical" role="tablist">
	...
	<?php $active = ($key == 0)? "active":""; ?>
		<li class="<?php echo $active; ?>">
			<a data-toggle="tab" data-id_unidad_funcional="<?php echo $unidad_funcional->id; ?>" href="#<?php echo $unidad_funcional->id; ?>_unidad_funcional"><?php echo lang("environmental_impacts_by") . ' ' . $unidad_funcional->unidad. ' ' . lang("of") . ' ' . $unidad_funcional->nombre; ?></a>
		</li>
	<?php } ?>
</ul>
</div>
