...
<!--Breadcrumb section-->
    <nav class="breadcrumb">
        ...
        <a class="breadcrumb-item" href="#"><?php echo lang("water_environmental_footprints"); ?> /</a>
        <a class="breadcrumb-item" href="<?php echo get_uri("functional_units_water"); ?>"><?php echo lang("functional_units"); ?></a>
    </nav>
...
<script type="text/javascript">
    ...
    // functional_units_water/client/functional_units_by_date2.php y functional_units_water/client/functional_unit_by_date2.php
    ...
    $(document).ready(function () {
        ...
        function exportar_pdf(ids_uf){
            ...
            $.ajax({
                url:  '<?php echo_uri("functional_units_water/get_pdf") ?>',
                type:  'post',
                data:{
                    ids_uf: ids_uf,
		...
		function borrar_temporal(uri){
			$.ajax({
				url:  '<?php echo_uri("functional_units_water/borrar_temporal") ?>',
				type:  'post',
				data: {uri:uri},
				//dataType:'json',
				success: function(respuesta){
		...
		$('#btn_generar').click(function(){
			...
			if(start_date && end_date){
				if((start_date < end_date) || (start_date == end_date)){
					...
					$.ajax({
						url:'<?php echo_uri("functional_units_water/get_functional_units"); ?>',
						type:'post',
						data:{
							start_date: start_date,
							end_date: end_date,
