...
class Consolidated_impacts extends MY_Controller {
    ...
    public function index() {
		...
		$view_data['array_grafico_consumos_volumen_data'] = $this->generar_datos_grafico($array_id_materiales_valores_volumen, 'Consumo', $id_cliente, $years, $meses);
		...
		$view_data['array_grafico_consumos_masa_data'] = $this->generar_datos_grafico($array_id_materiales_valores_masa, 'Consumo', $id_cliente, $years, $meses);
		...
		$view_data['array_grafico_consumos_energia_data'] = $this->generar_datos_grafico($array_id_materiales_valores_energia, 'Consumo', $id_cliente, $years, $meses);
		...
		$view_data['array_grafico_residuos_volumen_data'] = $this->generar_datos_grafico($array_id_materiales_valores_volumen_residuo, 'Residuo', $id_cliente, $years, $meses);
		...
		$view_data['array_grafico_residuos_masa_data'] = $this->generar_datos_grafico($array_id_materiales_valores_masa_residuo, 'Residuo', $id_cliente, $years, $meses);
	...
	function generar_datos_grafico(array $array_id_materiales_valores_por_flujo, string $flujo, int $id_cliente, array $years, array $meses){
