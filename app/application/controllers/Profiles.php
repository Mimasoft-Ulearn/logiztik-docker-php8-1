...
class Profiles extends MY_Controller {
	...
	function modal_form() {
		...
		if($profile_id){
			$view_data['clients_modules'] = $this->Clients_modules_model->get_details_edit_mode($profile_id)->result();
		} else {
			//$view_data['clients_modules'] = $this->Clients_modules_model->get_details()->result();
			$view_data['clients_modules'] = $this->Clients_modules_model->get_modules_and_submodules()->result();
		}
