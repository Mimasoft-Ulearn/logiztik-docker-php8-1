...
class Dashboard extends MY_Controller {
	...
	function view($id_proyecto = 0){
		...
		$array_id_categorias_valores_volumen = $this->calculo_valores_por_flujo_categoria($formularios_flujo_consumo, 2, 'Consumo', $id_unidad_volumen_configuracion, $years, $meses); // tipo_unidad 2 es Volumen
		
		$view_data['array_id_categorias_valores_volumen'] = $array_id_categorias_valores_volumen;

		$array_grafico_consumos_volumen_data = $this->generar_datos_grafico($array_id_categorias_valores_volumen, 'Consumo', $id_cliente, $id_proyecto, $years, $meses);
		...
		$array_id_categorias_valores_masa = $this->calculo_valores_por_flujo_categoria($formularios_flujo_consumo, 1, 'Consumo', $id_unidad_masa_configuracion, $years, $meses); // tipo_unidad 1 es Masa
		
		$view_data['array_id_categorias_valores_masa'] = $array_id_categorias_valores_masa;
		// echo '<pre>'; var_dump($array_id_categorias_valores_masa); exit;

		$array_grafico_consumos_masa_data = $this->generar_datos_grafico($array_id_categorias_valores_masa, 'Consumo', $id_cliente, $id_proyecto, $years, $meses);
		...
		$array_id_categorias_valores_energia = $this->calculo_valores_por_flujo_categoria($formularios_flujo_consumo, 4, 'Consumo', $id_unidad_energia_configuracion, $years, $meses); // tipo_unidad 4 es Energia
		
		$view_data['array_id_categorias_valores_energia'] = $array_id_categorias_valores_energia;
		// echo '<pre>'; var_dump($array_id_categorias_valores_energia); exit;

		$array_grafico_consumos_energia_data = $this->generar_datos_grafico($array_id_categorias_valores_energia, 'Consumo', $id_cliente, $id_proyecto, $years, $meses);
		...
		$id_unidad_volumen_configuracion = $view_data['id_unidad_volumen'];
		$array_id_categorias_valores_volumen_residuo = $this->calculo_valores_por_flujo_categoria($formularios_flujo_residuo, 2, 'Residuo', $id_unidad_volumen_configuracion, $years, $meses); // tipo_unidad 2 es Volumen
		
		// echo '<pre>'; var_dump($array_id_categorias_valores_volumen_residuo); exit;
		$view_data['array_id_categorias_valores_volumen_residuo'] = $array_id_categorias_valores_volumen_residuo;
		
		$array_grafico_residuos_volumen_data = $this->generar_datos_grafico($array_id_categorias_valores_volumen_residuo, 'Residuo', $id_cliente, $id_proyecto, $years, $meses);
		...
		$id_unidad_masa_configuracion = $view_data['id_unidad_masa'];
		$array_id_categorias_valores_masa_residuo = $this->calculo_valores_por_flujo_categoria($formularios_flujo_residuo, 1, 'Residuo', $id_unidad_masa_configuracion, $years, $meses); // tipo_unidad 1 es Masa
		
		$view_data['array_id_categorias_valores_masa_residuo'] = $array_id_categorias_valores_masa_residuo;
		// echo '<pre>'; var_dump($array_id_categorias_valores_masa_residuo); exit;

		$array_grafico_residuos_masa_data = $this->generar_datos_grafico($array_id_categorias_valores_masa_residuo, 'Residuo', $id_cliente, $id_proyecto, $years, $meses);
	...
	function calculo_valores_por_flujo_categoria(array $formularios_por_flujo, int $tipo_unidad, string $flujo, int $id_unidad_configuración, array $years, array $meses){
				...
				foreach($categorias as $cat){
					...
					foreach($years as $year){
						foreach($meses as $index => $mes){
							$array_id_categorias_valores_volumen[$cat->id_categoria][$year][$index] = 0;
						}
					}
					...
					foreach($elementos_form as $ef){
						...
						if($id_unidad == $id_unidad_configuración){
							...
							$array_id_categorias_valores_volumen[$cat->id_categoria][$agno][$mes] += $valor;
							...
							$array_id_categorias_valores_volumen[$cat->id_categoria][$agno][$mes] += $valor * $valor_transformacion;
	...
	function generar_datos_grafico(array $array_id_categorias_valores_por_flujo, string $flujo, int $id_cliente, int $id_proyecto, array $years, array $meses){
			...
			foreach ($array_id_categorias_valores_por_flujo as $id_categoria => $arreglo_valores_by_year){
				...
				if($row_categoria->grafico){
					...
					$serie['data'][] = array(
						...
						'drilldown' => 'id_drilldown_'.$id_categoria.'_'.$year.'_'.$nombre_categoria
					);
				}
			}
			$series[] = $serie;
		...
		foreach($years as $year){
			foreach ($array_id_categorias_valores_por_flujo as $id_categoria => $arreglo_valores_by_year){
				...
				if($row_categoria->grafico){
					...
					$serie = array(
						'id' => 'id_drilldown_'.$id_categoria.'_'.$year.'_'.$nombre_categoria,
